<?php
 ...
 /* $Id: imdb.class.php 522 2012-11-26 07:11:53Z izzy $ */
  ...
  * @version $Revision: 522 $ $Date: 2012-11-26 18:11:53 +1100 (Mon, 26 Nov 2012) $
  */
 ...
 #-----------------------------------------------------------[ Constructor ]---
  ...
  function __construct($id) {
    ...
    $this->revision = preg_replace('|^.*?(\d+).*$|','$1','$Revision: 522 $');
    $this->setid($id);
  }
